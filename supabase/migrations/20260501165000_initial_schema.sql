-- Initial Supabase schema for Dozara.
-- Safe to run against an empty project; existing policies with the same names
-- are refreshed before being recreated.
...
drop policy if exists "Users manage own stock events" on public.stock_events;
